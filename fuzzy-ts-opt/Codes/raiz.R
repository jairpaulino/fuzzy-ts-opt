...
#FTS-GA
# onestep_ftsga = oneStepAheadForecasting(series = data_all,
...
onestep_ftssa = oneStepAheadForecastingSA(series = data_all,
...
names(results) = c("OBS", "ARIMA", "ETS", "FTS_SA")#, "FTS_GA")#, "FTS_SA")
...
metricsTrain = calculateMetrics(na.omit(results[1:m,]))
...
colnames(procTime) = c("ARIMA", "ETS", "FTS_SA")
...
#procTime$FTS_GA = saParameters$procTime
